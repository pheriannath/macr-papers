  ...
  return (
    <div>
      ...
      <p>
        ...
        return, but also a space of deferral and anticipation. The Library’s
        archaic recuperation of the past is inseparable from its speculative
        projection into the future. Through the near-empty space of the Library,
        the time of the project becomes dramatically stretched beyond the
        lifespans of its initial creators: Paterson remarks, ‘[w]hen I had the
        idea for Future Library I knew instantly it would outlive me (and most
        of us alive today). It is important that I do not see it fully
        realized—it is a work conceived for an unknown, future generation.’ This
        space, then, is proleptically haunted by the future, paradoxically
        filled by both the absent presence of the books to come, and the
        gradual, inevitable disappearance of those texts’ mortal writers,
      ...
      <ul className="bibliography">
        <li>
          ...
          the Anthropocene.” In Publishing as Artistic Practice, edited by
          Annette Gilbert, 282–95. Berlin: Sternberg Press, 2016.
        </li>

        <li>
          Future Library. “Future Library, 2014¬2114.” Accessed February 16,
          2023.{" "}
          <a href="https://www.futurelibrary.no">
      ...
      <hr />
      <cite>
        <sup id="annotation-1">1.</sup> Future Library, “Future Library,
